    ...
    def do_GET(self):
        ...
        try:
            ...
            if self.path.startswith('/logos/'): # 302 Temporary Redirect
                ...
                self.send_header('Location', f'http://{PROPERTIES.getRemoteHost()}/images/{Globals._quoteString(self.resources.getImageCache(Globals._unquoteString(self.path.split("/logos/")[1])))}')
