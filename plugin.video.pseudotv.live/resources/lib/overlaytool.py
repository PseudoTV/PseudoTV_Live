...
class OverlayTool(xbmcgui.WindowXMLDialog):
    ...
    def onInit(self):
        ...
        self.channelBug      = xbmcgui.ControlImage(self.channelBugX, self.channelBugY, 128, 128, LOGO_COLOR, 2, self.channelBugColor) #IDX 1
        self.onNext_Artwork  = xbmcgui.ControlImage(self.onNextX, self.onNextY, 256, 128, FANART_COLOR, 0) #IDX 2
